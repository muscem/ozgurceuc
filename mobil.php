...
msgY="<center><img src=\"logo_ozgurceuc.png\" /><br><h1>www.ozgurceuc.com</h1><br><img src=\"ajax-loader.gif\" /><br>"+msgY+"</center>";
...
function baslangic(){
//yukleniyor("");
if(kapat==0){		//Bcak tuşunu basılıp kapatmak istenmediyse
...
//alert("cem mobile= "+jQuery.browser.mobile);

//alert("user="+navigator.userAgent+"\nlang="+navigator.userLanguage);
...
//alert("açılış");
//})
kapat=1;	//Havaalanları ile ilgili menülere sadece ilk açılışta otomatik olarak bakılacak
...
//yukleniyor("Seçtiğiniz güzergahta uçuş arama işlemi gerçekleştirilmektedir. Lütfen bekleyiniz!");
}
}
...
var gidis_goster=0;	//Bütün gidiş sonuçları gösteriliyor
var donus_goster=0;	//Bütün dönüş sonuçları gösteriliyor
var gidis_donus_goster=0;	//Bütün gidiş dönüş sonuçları gösteriliyor
...
//Back tuşuna basıldığında kapansın
...
$("#ana_sayfa").live( 'pagebeforechange',function(event){

});


/*
//İki farklı uyggulama kapatma kodu kullnıyorum

/*   !!!!! Bu yöntem, sonuçları sıralamayı bozuyor o yüzden iptal edildi!!!
//Birincisi, her sayfa değişiminde backbutton history temizleniyor
//Böylece geriye gidilecek sayfa olmaması lazım. Bu durumda uygulama kapanacak
$(document).live( 'pagechange',function(event){
//alert("active="+jQuery.mobile.urlHistory.activeIndex);
//alert("len="+jQuery.mobile.urlHistory.stack.length);//pop();
//jQuery.mobile.urlHistory.stack.pop();
jQuery.mobile.urlHistory.stack.length=0;
//alert("active="+jQuery.mobile.urlHistory.activeIndex);
//alert("len="+jQuery.mobile.urlHistory.stack.length);
jQuery.mobile.urlHistory.activeIndex = 0;
});
*/
//İkinci, uygulama kapatma yöntemi 
//back button basıldığında bir kapatmak istenip istenmediği sorulup, kapatma koduyla kapatılacak.
